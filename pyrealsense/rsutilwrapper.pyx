...
cdef extern from "rsutilwrapper.h":
    ...
    void _deproject_pixel_to_point(float* point, const rs_intrinsics* intrin, const float* pixel, const float depth)
    void _deproject_depth(float* poincloud, const rs_intrinsics* intrin, const uint16_t* depth_image, const float depth_scale)
